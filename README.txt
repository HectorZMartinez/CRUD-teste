...
1º A edição dos contatos não foi implementada.
2º Existe uma opção do usuário alterar sua senha ou deletar sua conta.
3º O usuário pode ver os contatos que ele cadastrou.
